...
assert.match(appSource, /online_managed: new Set\(\["home", "study-todo", "study-cafe", "feedback", "grades", "mypage", "push-settings", "other-settings", "notifications", "notices"\]\)/);
assert.match(appSource, /lecture: new Set\(\["home", "curriculum", "study-todo", "study-cafe", "feedback", "question-board", "inquiry-board", "study-ranking", "study-timer", "study-character", "study-shop", "mypage", "faq", "push-settings", "other-settings", "notifications", "notices"\]\)/);
