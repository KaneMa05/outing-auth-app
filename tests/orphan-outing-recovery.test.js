...
assert.match(indexSource, /shared\.js\?v=20260730-orphan-outing-recovery/);
assert.match(indexSource, /student\.js\?v=20260730-orphan-outing-recovery/);
assert.match(teacherSource, /shared\.js\?v=20260730-orphan-outing-recovery/);
assert.match(serviceWorkerSource, /outing-auth-app-v249-orphan-outing-recovery/);
