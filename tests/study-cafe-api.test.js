...
assert.match(apiSource, /const idleReleaseActivityAt = isIdle \? idleActivityAt : lastHeartbeatAt/);
...
assert.match(apiSource, /const automaticIdleRelease = body\.idleAutoRelease === true/);
assert.match(apiSource, /const releasePresence = automaticIdleRelease \? await getOwnPresence\(studentId\) : null/);
