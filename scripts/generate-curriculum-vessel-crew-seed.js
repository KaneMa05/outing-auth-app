...
const subjects = [
  {
    ...
    shortName: "항해",
    tone: "teal",
    targetTracks: [NAVIGATION_TRACK, ACADEMY_NAVIGATION_TRACK],
    sortOrder: 1,
    stages: [
      ["오리엔테이션", 1, 1],
      ["선박의 개요", 2, 5],
  ...
  },
  {
    ...
    shortName: "기관",
    tone: "violet",
    targetTracks: [ENGINE_TRACK, ACADEMY_ENGINE_TRACK],
    sortOrder: 1,
    stages: [
      ["오리엔테이션", 1, 1],
      ["열기관 기초", 2, 8],
  ...
  },
  {
    ...
    shortName: "영어",
    tone: "indigo",
    targetTracks: [NAVIGATION_TRACK, ENGINE_TRACK, ACADEMY_NAVIGATION_TRACK, ACADEMY_ENGINE_TRACK],
    sortOrder: 2,
    stages: [
      ["오리엔테이션", 1, 1],
      ["SMCP 기초", 2, 5],
