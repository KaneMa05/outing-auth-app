const CACHE_NAME = "outing-auth-app-v425-release-review";
const APP_SHELL = [
  "/",
  "/index.html",
  "/teacher",
  ...
  "/styles.css?v=20260911-hair-shop-bot-admin-reward-celebration",
  ...
  "/feedback-hub.js?v=20260911-feedback-titles",
